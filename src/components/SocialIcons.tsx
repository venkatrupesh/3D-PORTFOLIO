  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/venkatrupesh" target="_blank">
            <FaGithub />
          </a>
        </span>
        <span>
          <a href="https://www.linkedin.com/in/koyyagura-venkata-rupesh-22ba0628a" target="_blank">
            <FaLinkedinIn />
          </a>
        </span>
        <span>
          <a href="https://www.instagram.com/k.v._rupesh" target="_blank">
            <FaInstagram />
          </a>
        </span>
      </div>
